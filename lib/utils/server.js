...
export const formatId = id => typeof id === 'object' ? new MongoID.ObjectID(id._str || id.toHexString?.()) : id; // support for Mongo ObjectId
...
export const getCursor = (cursor, args) => {
  ...
  // at this point, we need update the query to include the sort field field for pagination with the correct sort order
